<template>
  <section class="space-y-4 my-4">
    <input
      ...
      class="form-input w-full rounded-xl border border-surface-border bg-surface px-4 py-2 text-surface-fg outline-none transition placeholder:text-muted-fg focus:border-primary focus:ring-2 focus:ring-primary"
      @input="onSearchInput"
    >
    <AppTable
      :columns="columns"
